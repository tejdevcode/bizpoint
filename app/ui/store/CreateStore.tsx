...
import { createStorefront, State } from "../../lib/actions";
const CreateStore = () => {
         ...
         <form className="business-form bg-white shadow-lg rounded-lg p-8 space-y-3 w-full max-w-md mx-auto" action={formAction} >
            ...
            <div>
               ...
               <input type="text" id="owner_name" name="owner_name"
                  className="mt-1 block w-full rounded-md border border-gray-300 px-2 py-1.5 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            ...
            <div>
               ...
               <input type="text" id="business_name" name="business_name"
                  className="mt-1 block w-full rounded-md border border-gray-300 px-1.5 py-1.5 shadow-sm focus:border-blue-500 focus:ring-blue-500"
